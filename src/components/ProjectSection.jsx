...
const developmentTestProjects = [
  {
    id: 'test-dashboard', title: 'Orbit Dashboard', category: 'Development',
    description: 'Dashboard conceitual para acompanhar métricas e indicadores.',
  ...
  {
    id: 'test-api', title: 'Flow API', category: 'Development',
    description: 'Estrutura conceitual de API para integrações e automações.',
  ...
  {
    id: 'test-landing', title: 'Nexa Landing', category: 'Development',
    description: 'Landing page conceitual com foco em conversão e responsividade.',
  ...
  {
    id: 'test-commerce', title: 'Vertex Commerce', category: 'Development',
    description: 'E-commerce conceitual com catálogo, pagamentos e gestão de pedidos.',
