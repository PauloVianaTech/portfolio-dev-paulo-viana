...
export const projectsData = [
  ...
  {
    id: "drip-store",
    title: "Teste Projeto: Drip Store",
    category: "Development",
    featured: true,
    date: "03-2026",
    status: "Completed",
    description:
      "Os projetos reais estao sendo preparados para serem expostos neste portfolio - Previsao 05/09. E-commerce front-end desenvolvido com foco em responsividade, experiencia do usuario e interface moderna.E-commerce front-end desenvolvido com foco em responsividade, experiencia do usuario e interface moderna. ",
    types: ["Frontend", "E-commerce", "CRM", "Portfolio", "UI Design", "Motion Design", "Mobile App", "Data Visualization"],
  ...
  },
  {
    id: "backend-gt3",
    category: "Development",
    title: "Teste Projeto: Backend GT3",
    description: "Os projetos reais estao sendo preparados para serem expostos neste portfolio - Previsao 05/09. Estrutura backend para aplicacoes web com organizacao de rotas, controllers e servicos.",
    types: ["Backend"],
  ...
  // DESIGN
  {
    ...
    category: "Design",
    title: "Teste Projeto: Social Media Design",
    description: "Os projetos reais estao sendo preparados para serem expostos neste portfolio - Previsao 05/09. Projetos voltados para redes sociais, campanhas visuais e conteudo digital.",
    types: ["Social Media"],
    context: "Projeto de estudo",
  ...
  },
  {
    id: "brand-id-v2",
    category: "Design",
    title: "Teste Projeto: Brand Identity V2",
    types: ["Brand Identity"],
    context: "Projeto de estudo",
    featured: false,
    date: "03-2026",
    status: "Completed",
    description: "Os projetos reais estao sendo preparados para serem expostos neste portfolio - Previsao 05/09. Criacao de identidade visual, logos e materiais graficos.",
  ...
  // TRADING
  {
    id: "macd-pullback-v2",
    category: "Trading",
    title: "Teste Projeto: MACD Pullback Strategy V2",
    description: "Os projetos reais estao sendo preparados para serem expostos neste portfolio - Previsao 05/09. Indicador para automacao de operacoes baseado em pullback e confirmacao de tendencia.",
  ...
  },
  {
    ...
    category: "Trading",
    title: "Teste Projeto: Trading Automation V2",
    description: "Os projetos reais estao sendo preparados para serem expostos neste portfolio - Previsao 05/09. Projetos voltados para automacao, alertas e estrategias para mercado financeiro.",
    types: ["Automation"],
    context: "Projeto de estudo",
