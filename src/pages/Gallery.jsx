    ...
    return (
        ...
        >
            <div className="text-center mb-8 md:mb-16 px-4">
                <h1 className="text-3xl md:text-6xl font-black font-display tracking-tighter mb-4">
            ...
            {!isLoading && activities.length === 0 && (
                <div className="text-center py-20 dark:text-slate-500 text-slate-400">
                    <p>Nenhuma atividade por aqui ainda. Volte em breve!</p>
                </div>
            )}
                                ...
                                <div className="p-4 border-t dark:border-slate-800 border-slate-200 bg-white dark:bg-slate-900 flex-shrink-0 pb-safe">
                                    <div className="flex items-center gap-4 mb-3">
                                        ...
                                        >
                                            ...
                                            <span className="font-semibold">{selectedActivity.likes || 0} curtidas</span>
                                        </button>
                                    </div>
